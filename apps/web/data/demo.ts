...
export const demoProfiles: SearchProfile[] = [
  {
    ...
    source: 'youtube',
    operation: 'search',
    parameters: { query: 'freetekno liveset' },
    schedule_cron: '0 6 * * *',
  ...
  },
  {
    ...
    source: 'youtube',
    operation: 'search',
    parameters: { query: 'tribe b2b dj set' },
    schedule_cron: '0 6 * * *',
    last_run_at: null,
  ...
  },
  {
    ...
    source: 'youtube',
    operation: 'search',
    parameters: { query: 'teknival recorded at' },
    schedule_cron: '0 6 * * *',
    last_run_at: '2026-07-27T06:00:00Z',
    last_scheduled_at: '2026-07-27T06:00:00Z',
    next_scheduled_at: '2026-07-28T06:00:00Z',
    next_page_token: null,
    last_result_count: 0,
